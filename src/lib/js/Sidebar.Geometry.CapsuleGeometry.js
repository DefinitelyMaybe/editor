...
function GeometryParametersPanel(editor, object) {
  ...
  radiusRow.add(
    new UIText(
      strings.getKey("sidebar/geometry/capsule_geometry/radius")
    ).setWidth("90px")
  );
  ...
  lengthRow.add(
    new UIText(
      strings.getKey("sidebar/geometry/capsule_geometry/length")
    ).setWidth("90px")
  );
  ...
  capSegmentsRow.add(
    new UIText(
      strings.getKey("sidebar/geometry/capsule_geometry/capseg")
    ).setWidth("90px")
  );
  ...
  radialSegmentsRow.add(
    new UIText(
      strings.getKey("sidebar/geometry/capsule_geometry/radialseg")
    ).setWidth("90px")
  );
